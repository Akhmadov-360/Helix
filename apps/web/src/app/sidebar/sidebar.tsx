  ...
  return (
    <aside className="flex h-dvh w-64 shrink-0 flex-col bg-sidebar text-sidebar-foreground">
      ...
      <nav className="scroll-slim flex flex-1 flex-col gap-3 overflow-y-auto p-2">
        ...
        {/* Участники/Аудит читает любая роль (GET /organizations/members и /audit-log без
            @CheckPolicy) — MembersPage сама прячет контролы редактирования по Membership.update/
            delete, здесь прятать нечего. */}
